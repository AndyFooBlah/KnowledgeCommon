...
/**
 * Date/time Gemini tools for KnowledgeCommon AI agents.
 *
 ...
 *
 * Register via allKnowledgeTools in lib.ts or compose a custom subset.
 */
    ...
    properties: {
      ...
      currentDateTime: {
        ...
        description:
          ...
          '(e.g. "Sunday, April 13, 2026 at 12:00 AM PDT").',
      },
    },
